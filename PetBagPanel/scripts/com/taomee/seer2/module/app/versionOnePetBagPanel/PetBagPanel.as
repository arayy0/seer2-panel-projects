...
import flash.utils.IDataInput;
   ...
   public class PetBagPanel extends Module {
      ...
      private function onRequestRecover(e:Event = null) : void {
         e.stopPropagation();
         this._petListPanel.requestAddAllPetBlood();
      }
      
      private function onPetAddedHp(e:PetBagEvent) : void {
         e.stopPropagation();
         this._petListPanel.updateDisplay();
         this._petDemoPanel.showHpAnimation(e.petInfo);
      }
      
      private function onPetAddedHp2(e:MessageEvent) : void {
         this._petListPanel.updateDisplay();
         this._petDemoPanel.showHpAnimation();
      }
      ...
      private function getPetHideSkillCount(petInfo:PetInfo) : Boolean {
         return PetUtil.getMaxStatusPet(petInfo.bunchId).resId == petInfo.resourceId;
      }
