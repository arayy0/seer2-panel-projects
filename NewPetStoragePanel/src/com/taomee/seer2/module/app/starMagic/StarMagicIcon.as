...
public class StarMagicIcon extends Sprite
{
   ...
   private function showIcon() : void
   {
      ...
      if(!this._mc2)
      {
         this._mc2 = new default_staricon();
         this._mc2.x = 15;
         this._mc2.y = 18;
         this._mc2.alpha = 0;
   ...
   private function toPosition(sx:Number, sy:Number, tx:Number, ty:Number, speed:uint) : Point
   {
      ...
      var radian:Number;
      var angel:Number = (radian = Math.atan2(p2.y - p.y,p2.x - p.x)) * 180 / 3.141592653589793;
   ...
   public function getMovieClip() : MovieClip
   {
      ...
      if(!info)
      {
         return new default_staricon();
      }
      if(this._id == 0)
      {
         m = new default_staricon();
         m.alpha = 0;
      }
      else if(this._id == 1)
      {
