...
import flash.events.MouseEvent;
   ...
   public class PetInfoPanel extends StorageSubView
   {
      ...
      private var _5StarPetsFreeableList:Array = [503,693,728,734,746,757,787,788,799,800,803,804,827,836,881,892,897,910,913,916,918,939,941,942,946,948,949,950,952,955,957,960,961,965,967,971,972,973,977,982,984,990,991,993,2507,2518,2550,2551,2552,2555,2558,2559,2560];

      private var _under4StarsExtinctPetsList:Array = [618,632,640,902,914,997,2525,2561,2590];
