package flashx.textLayout.elements
{
   ...
   public class TextFlow extends ContainerFormattedElement implements IEventDispatcher
   {
      ...
      tlf_internal function changeFlowComposer(newComposer:IFlowComposer, okToUnloadGraphics:Boolean) : void
      {
         ...
         {
            oldSWFContext = FlowComposerBase.tlf_internal::computeBaseSWFContext(!!this._flowComposer ? this._flowComposer.swfContext : null);
            newSWFContext = FlowComposerBase.tlf_internal::computeBaseSWFContext(!!newComposer ? newComposer.swfContext : null);
