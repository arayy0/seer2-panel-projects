package flashx.textLayout.compose
{
   ...
   public class ParcelList
   {
      ...
      private function get measureLogicalWidth() : Boolean
      {
         ...
         return this._verticalText ? controller.tlf_internal::measureHeight : controller.tlf_internal::measureWidth;
      }
      ...
      private function get measureLogicalHeight() : Boolean
      {
         ...
         var controller:ContainerController = this._currentParcel.controller;
         return this._verticalText ? controller.tlf_internal::measureWidth : controller.tlf_internal::measureHeight;
      }
