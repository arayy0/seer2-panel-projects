package flashx.textLayout.compose
{
   ...
   public final class TextFlowLine implements IVerticalJustificationLine
   {
      ...
      tlf_internal static function initializeNumberLinePosition(numberLine:TextLine, listItemElement:ListItemElement, curParaElement:ParagraphElement, totalWidth:Number) : void
      {
         ...
         var listEndIndent:Number = listMarkerFormat.paragraphEndIndent === undefined || listItemElement.computedFormat.listStylePosition == ListStylePosition.INSIDE ? 0 : (listMarkerFormat.paragraphEndIndent == FormatValue.INHERIT ? paragraphFormat.paragraphEndIndent : Number(listMarkerFormat.paragraphEndIndent));
      ...
      public function getBounds() : Rectangle
      {
         ...
         var bp:String = this.paragraph.tlf_internal::getAncestorWithContainer().computedFormat.blockProgression;
      ...
      tlf_internal function getLineLeading(bp:String, elem:FlowLeafElement, elemStart:int) : Number
      {
         ...
         while(true)
         {
            elemLeading = elem.tlf_internal::getEffectiveLineHeight(bp);
      ...
      {
         return tlf_internal::getTextLineTypographicAscent(!!textLine ? textLine : this.getTextLine(),elem,elemStart,this.absoluteStart + this.textLength);
      }
      ...
      private function makeBlock(textLine:TextLine, begTextIndex:int, begAtomIndex:int, endAtomIndex:int, startMetrics:Rectangle, blockProgression:String, direction:String, heightAndAdj:Array) : Rectangle
      {
         ...
         var justRule:String = this._para.tlf_internal::getEffectiveJustificationRule();
