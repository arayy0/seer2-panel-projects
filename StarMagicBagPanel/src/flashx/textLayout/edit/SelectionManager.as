package flashx.textLayout.edit
{
   ...
   public class SelectionManager implements ISelectionManager
   {
      ...
      private function selectionPoint(currentTarget:Object, target:InteractiveObject, localX:Number, localY:Number, extendSelection:Boolean = false) : SelectionState
      {
         ...
         if(begIdx == endIdx)
         {
            begIdx = NavigationUtil.tlf_internal::updateStartIfInReadOnlyElement(this._textFlow,begIdx);
            endIdx = NavigationUtil.tlf_internal::updateEndIfInReadOnlyElement(this._textFlow,endIdx);
         }
         else
         {
            endIdx = NavigationUtil.tlf_internal::updateEndIfInReadOnlyElement(this._textFlow,endIdx);
      ...
      {
         var idx:int = int(this.marks.indexOf(mark));
         if(idx != -1)
         {
