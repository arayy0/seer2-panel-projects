   ...
   public class ElementRange
   {
      ...
      private static function adjustForLeanLeft(rslt:ElementRange) : void
      {
         ...
         if(rslt.firstLeaf.getAbsoluteStart() == rslt.absoluteStart)
         {
            ...
            {
               if((!(previousNode.parent is SubParagraphGroupElementBase) || (previousNode.parent as SubParagraphGroupElementBase).tlf_internal::acceptTextAfter()) && (!(rslt.firstLeaf.parent is SubParagraphGroupElementBase) || previousNode.parent === rslt.firstLeaf.parent))
               {
