   ...
   public class CreateListOperation extends FlowTextOperation
   {
      ...
      override public function doOperation() : Boolean
      {
         ...
         else
         {
            ...
            if(target is ListItemElement && (target as ListItemElement).tlf_internal::normalizeNeedsInitialParagraph())
            {
            ...
            if(Boolean(testListItem) && testListItem.tlf_internal::normalizeNeedsInitialParagraph())
            {
