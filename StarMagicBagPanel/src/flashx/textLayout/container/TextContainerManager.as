package flashx.textLayout.container
{
   ...
   public class TextContainerManager extends EventDispatcher implements ISWFContext, IInteractionEventHandler, ISandboxSupport
   {
      ...
      public function TextContainerManager(container:Sprite, configuration:IConfiguration = null)
      {
         ...
         this._config = !!configuration ? tlf_internal::customizeConfiguration(configuration) : defaultConfiguration;
      ...
      public function callInContext(fn:Function, thisArg:Object, argsArray:Array, returns:Boolean = true) : *
      {
         ...
         if(Boolean(textBlock) && _expectedFactoryCompose == TextLineFactoryBase.tlf_internal::_factoryComposer)
         {
            ...
            if(Configuration.tlf_internal::playerEnablesArgoFeatures && fn == thisArg["recreateTextLine"])
            {
      ...
      public function drawBackgroundAndSetScrollRect(scrollX:Number, scrollY:Number) : Boolean
      {
         ...
         else
         {
            ...
            contentWidth = controller.tlf_internal::contentWidth;
            contentHeight = controller.tlf_internal::contentHeight;
         }
         if(isNaN(this.compositionWidth))
         {
            contentLeft = this._composeState == tlf_internal::COMPOSE_FACTORY ? this._contentLeft : controller.tlf_internal::contentLeft;
         ...
         {
            contentTop = this._composeState == tlf_internal::COMPOSE_FACTORY ? this._contentTop : controller.tlf_internal::contentTop;
