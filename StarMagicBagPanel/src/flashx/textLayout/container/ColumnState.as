package flashx.textLayout.container
{
   ...
   public class ColumnState
   {
      ...
      {
         var newPaddingTop:Number = controller.tlf_internal::getTotalPaddingTop();
         var newPaddingBottom:Number = controller.tlf_internal::getTotalPaddingBottom();
         var newPaddingLeft:Number = controller.tlf_internal::getTotalPaddingLeft();
         var newPaddingRight:Number = controller.tlf_internal::getTotalPaddingRight();
