package fl.timeline.timelineManager
{
   ...
   public class InstanceInfo
   {
      ...
      public function clone() : InstanceInfo
      {
         ...
         if(this.prev != null)
         {
            newXns.push(new InstanceInfo(this.prev.container,this.prev.instanceName,this.prev.startFrame,this.prev.endFrame,0));
         }
         if(this.next != null)
         {
            newXns.push(new InstanceInfo(this.next.container,this.next.instanceName,this.next.startFrame,this.next.endFrame,1));
         }
         if(this.parent != null)
         {
            newXns.push(new InstanceInfo(this.parent.container,this.parent.instanceName,this.parent.startFrame,this.parent.endFrame,3));
         }
         if(this.children != null)
         {
            ...
            {
               ii = this.children[i];
               newXns.push(new InstanceInfo(ii.container,ii.instanceName,ii.startFrame,ii.endFrame,2));
               i++;
            }
         }
