package com.taomee.seer2.module.app.userPanel
{
   ...
   internal class UserPanelTitleList extends Sprite
   {
      ...
      private function createChildren() : void
      {
         ...
         this._container.x = 52;
         this._container.y = -126;
      ...
      private function createScroller() : void
      {
         ...
         this._userTitleScroller.x = 157;
         this._userTitleScroller.y = -114;
      ...
      private function createItemVec() : void
      {
         ...
         this._userTitleItemContainer.x = 54;
         this._userTitleItemContainer.y = -126;
