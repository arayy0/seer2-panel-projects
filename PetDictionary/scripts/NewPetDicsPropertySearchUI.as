package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="NewPetDicsPropertySearchUI")]
   public dynamic class NewPetDicsPropertySearchUI extends MovieClip
   {
      ...
      public function NewPetDicsPropertySearchUI()
      {
         super();
      }
   }
